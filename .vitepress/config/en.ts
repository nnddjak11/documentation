...
const productsDir = resolve(__dirname, '../../en/products')
const openSourceDir = resolve(__dirname, '../../en/open-source')
...
// Scan a category directory and build sidebar items.
// Product pages are now index.md; supplementary pages use other names (e.g. reference.md).
