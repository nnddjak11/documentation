...
2. Clone the repository:
   ...
   ```
3. Open `platformio.ini` and select the `T-Echo-Lite-Kit` environment
...
void loop() {
    int state = radio.transmit("Hello T-Echo Lite Kit");
...
A: T-Echo Lite Kit includes the T-Echo Lite board plus accessories (antenna, battery, and enclosure components). Refer to the product page for the full kit contents.
